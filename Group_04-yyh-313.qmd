...
#| fig-align: center
#| message: false
ggplot(data=data,aes(x=Electricity,y=as.numeric(as.character(Total.Number.of.Family.members))))+geom_boxplot(aes(fill=Electricity))+labs(x="Electricity",y="Number of family members")
```
