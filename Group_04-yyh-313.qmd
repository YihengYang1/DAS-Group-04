...
data.norm <-apply(data2[,c("Total.Household.Income",
                              ...
                              "House.Floor.Area",
                              "House.Age",
                              "Number.of.bedrooms")], 2, function(x) (x-min(x))/(max(x)-min(x)) )

data.norm <- cbind(data.norm,data2[,c("Household.Head.Sex",
                                     "Type.of.Household",
                                     "Electricity")])
data.norm <-cbind(data2[,c("Total.Number.of.Family.members")],data.norm)
colnames(data.norm)[colnames(data.norm)=="data2[, c(\"Total.Number.of.Family.members\")]"] <- "Total.Number.of.Family.members" 
```
...
model1=glm(Total.Number.of.Family.members~Total.Household.Income+
             ...
             Type.of.Household+House.Floor.Area+House.Age+Number.of.bedrooms+Electricity,data=data.norm,family = poisson)
model1%>%
  summary()
confint(model1)%>%
  kable()
...
```{r}
# for conviniency, introduce a new dataset, which we can merge these two kinds of type of households in it without changing the original dataset.
...
```{r}
model2=glm(Total.Number.of.Family.members~Total.Household.Income+Total.Food.Expenditure+Household.Head.Sex+Household.Head.Age+Type.of.Household+House.Floor.Area+House.Age+Number.of.bedrooms+Electricity,data=data.norm.merged,family = poisson)
model2%>%
  summary()
```
...
```{r}
model3=glm(Total.Number.of.Family.members~Total.Household.Income+Total.Food.Expenditure+Household.Head.Sex+Household.Head.Age+Type.of.Household+House.Age+Number.of.bedrooms+Electricity,data=data.norm.merged,family = poisson)
```
...
```{r}
model_quasi <- glm(Total.Number.of.Family.members~Total.Household.Income+Total.Food.Expenditure+Household.Head.Sex+Household.Head.Age+Type.of.Household+House.Floor.Area+House.Age+Number.of.bedrooms+Electricity,data=data.norm,family = quasipoisson(link = "log"))
summary(model_quasi)
```
...
```{r}
model_quasi_1 <- glm(Total.Number.of.Family.members~Total.Household.Income+Total.Food.Expenditure+Household.Head.Sex+Household.Head.Age+Type.of.Household+House.Floor.Area+House.Age+Number.of.bedrooms+Electricity,data=data.norm.merged,family = quasipoisson(link = "log"))
...
```{r}
model_quasi_2 <- glm(Total.Number.of.Family.members~Total.Household.Income+Total.Food.Expenditure+Household.Head.Sex+Household.Head.Age+Type.of.Household+House.Age+Number.of.bedrooms+Electricity,data=data.norm.merged,family = quasipoisson(link = "log"))
...
```{r}
model_nb=glm.nb(Total.Number.of.Family.members~Total.Household.Income+Total.Food.Expenditure+Household.Head.Sex+Household.Head.Age+Type.of.Household+House.Floor.Area+House.Age+Number.of.bedrooms+Electricity,data=data.norm)
summary(model_nb)
```
...
```{r}
model_nb1 <- glm.nb(Total.Number.of.Family.members~Total.Household.Income+Total.Food.Expenditure+Household.Head.Sex+Household.Head.Age+Type.of.Household+House.Floor.Area+House.Age+Number.of.bedrooms+Electricity,data=data.norm.merged)
summary(model_nb1)
model_nb1$aic
```
...
```{r}
model_nb2 <- glm.nb(Total.Number.of.Family.members~Total.Household.Income+Total.Food.Expenditure+Household.Head.Sex+Household.Head.Age+Type.of.Household+House.Age+Number.of.bedrooms+Electricity,data=data.norm.merged)
summary(model_nb2)
model_nb2$aic
```
...
: AIC value of different GLM models {#tbl-AIC_glm.nb}
